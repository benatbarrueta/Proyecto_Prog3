						...
						string= string +asig.getNombre()+": \r\n";
							...
							for (Tarea tarea2 : GestorBD.gestorBD.obtenerDatosTareas()) {
								if(alumno.getId()==tarea2.getId_alumna() && tarea2.getId_asignatura()==asig.getId()) {
									string=string +"    "+tarea2.getNombre()+" - " + tarea2.getCalificacion()+" - " +tarea2.getFecha_fin()+" - " +tarea2.getPorcentaje()+"/100 \r\n";
									System.out.println("    "+tarea2.getNombre()+" - " + tarea2.getCalificacion()+" - " +tarea2.getFecha_fin()+" - " +tarea2.getPorcentaje()+"/100 \r\n");
								}
							}
						}
					}
